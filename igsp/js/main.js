;(function () {
	...
	var burgerMenu = function() {
		...
		$('body').on('click', '.js-aic-nav-toggle', function(event){
	...
	var clickMenu = function() {
		...
		$('#navbar a:not([class="external"])').click(function(event){
		    ...
		    if ( navbar.is(':visible')) {
		    	...
		    	$('.js-aic-nav-toggle').removeClass('active');
		    }
	...
	var windowScroll = function() {
		...
		$(window).scroll(function(event){
		   	...
		   	var header = $('#aic-header'),
				scrlTop = $(this).scrollTop();

			if ( scrlTop > 500 && scrlTop <= 2000 ) {
				header.addClass('navbar-fixed-top aic-animated slideInDown');
			} else if ( scrlTop <= 500) {
				if ( header.hasClass('navbar-fixed-top') ) {
					header.addClass('navbar-fixed-top aic-animated slideOutUp');
					setTimeout(function(){
						header.removeClass('navbar-fixed-top aic-animated slideInDown slideOutUp');
					}, 100 );
				}
			} 
	...
	var homeAnimate = function() {
		if ( $('#aic-home').length > 0 ) {	

			$('#aic-home').waypoint( function( direction ) {
										
				if( direction === 'down' && !$(this.element).hasClass('animated') ) {


					setTimeout(function() {
						$('#aic-home .to-animate').each(function( k ) {
							var el = $(this);
	...
	var counterWayPoint = function() {
		if ($('#aic-counter-section').length > 0 ) {
			$('#aic-counter-section').waypoint( function( direction ) {
